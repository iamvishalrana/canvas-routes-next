        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ${icalUrl ? `<td style="padding-right:10px;">
              <a href="${icalUrl}" style="display:inline-block;padding:11px 20px;font-family:Arial,Helvetica,sans-serif;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#c5a882;text-decoration:none;border:1px solid rgba(197,168,130,0.35);"><span style="color:#c5a882;">Apple / Outlook</span></a>
            </td>` : ''}
            ${gCalUrl ? `<td>
              <a href="${gCalUrl}" style="display:inline-block;padding:11px 20px;font-family:Arial,Helvetica,sans-serif;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#c5a882;text-decoration:none;border:1px solid rgba(197,168,130,0.35);"><span style="color:#c5a882;">Google Calendar</span></a>
            </td>` : ''}
          </tr>
        </table>
      </td></tr>` : ''
  ...
  <tr><td align="center" style="padding:48px 16px;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:560px;width:100%;">
      ...
      <tr><td style="padding-bottom:32px;" align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
          <tr><td style="background-color:#c5a882;">
            <a href="${SITE}/members/events" style="display:inline-block;padding:16px 40px;font-family:Arial,Helvetica,sans-serif;font-size:12px;letter-spacing:3px;text-transform:uppercase;color:#0F1E14;text-decoration:none;font-weight:600;"><span style="color:#0F1E14;">View My Events &rarr;</span></a>
          </td></tr>
        </table>
      </td></tr>
      ...
      <tr><td style="padding-top:20px;border-top:1px solid rgba(197,168,130,0.12);font-family:Arial,Helvetica,sans-serif;font-size:11px;color:rgba(245,241,236,0.3);line-height:1.8;">
        ...
        <a href="${SITE}" style="color:rgba(197,168,130,0.4);text-decoration:none;"><span style="color:rgba(197,168,130,0.4);">canvasroutes.com</span></a>
      </td></tr>
