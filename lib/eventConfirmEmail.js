    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:580px;">
      ...
      <tr><td style="background:#ffffff;padding:36px 40px 32px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
          <tr>
            ${profileUrl ? `<td style="padding-right:8px;"><a href="${profileUrl}" style="display:inline-block;padding:14px 32px;font-family:Arial,Helvetica,sans-serif;font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#F5F1EC;text-decoration:none;font-weight:600;background:#45643c;">Your Event Profile &rarr;</a></td>` : ''}
            ${isMember ? `<td><a href="${SITE}/members/events" style="display:inline-block;padding:14px 32px;font-family:Arial,Helvetica,sans-serif;font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#F5F1EC;text-decoration:none;font-weight:600;background:#0F1E14;">View My Events &rarr;</a></td>` : ''}
          </tr>
        </table>
