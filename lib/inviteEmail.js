...
<head>
  ...
  <title>You&rsquo;re confirmed &mdash; Canvas Routes</title>
</head>
  ...
  <tr><td align="center" style="padding:32px 16px 48px;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:580px;">
      ...
      <tr><td style="background:#0F1E14;padding:36px 40px 32px;">
        <img src="${SITE}/white-outline.png" alt="Canvas Routes" width="150" style="display:block;width:150px;height:auto;border:0;margin-bottom:28px;opacity:0.92;" />
