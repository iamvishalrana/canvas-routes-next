...
export function buildPendingReviewHtml({ firstName, eventName, dateDisplay, location, photoUrl }) {
  const body = `
...
export function buildAcceptedHtml({ firstName, eventName, dateDisplay, location, photoUrl }) {
  const body = `
