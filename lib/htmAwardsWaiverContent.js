// Hello to Montebello's check-in waiver text and awards categories — reused
// by the migration that seeds its events row, kept here (not inline in SQL)
// so it can be edited/reviewed like any other content file.

export const HTM_WAIVER_TEXT = `PARTICIPANT LIABILITY WAIVER & RELEASE OF CLAIMS
...
// Same three categories/questions WTET's awards use (lib/wtetAwardsContent.js),
// English only — the generic awards_categories column (unlike WTET's bespoke
// bilingual dictionary) stores one admin-authored copy per category.
export const HTM_AWARDS_CATEGORIES = [
  {
    id: 'best_energy',
...
export const HTM_LUNCH_OPTIONS = [
  { id: 'rotini', name: 'Rotini salad with pesto & grilled chicken', description: 'Rotini pasta salad with pesto, green olives, balsamic, and grilled chicken.' },
  { id: 'ravioli', name: 'Squash ravioli (vegetarian)', description: 'Squash ravioli in a cheese and sage sauce.' },
]
