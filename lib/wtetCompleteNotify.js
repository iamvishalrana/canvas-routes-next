  ...
  await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      html: buildAdminNotifyHtml('Whips to Eastern Townships — Check-in complete', [
        ...
        ['Waiver signed', `${app.wtet_waiver.full_name} on ${new Date(app.wtet_waiver.signed_at).toLocaleString('en-CA', { month: 'long', day: 'numeric', hour: 'numeric', minute: '2-digit', timeZone: 'America/Toronto' })}`],
        ['Lunch', lunchRow],
      ]),
    }),
  })
