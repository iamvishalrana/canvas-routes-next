...
// same hash for a constant-time compare. Exported for unit tests (the
// security-critical roundtrip) — not called directly outside this module.
export function hashSecret(secret, saltHex) {
