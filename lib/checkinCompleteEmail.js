...
// comes later, closer to the date, rather than immediately.
      ...
      <tr><td style="background:#ffffff;padding:36px 40px 32px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#EDE8E1;border-left:3px solid #c5a882;margin-bottom:20px;">
          <tr><td style="padding:20px 22px;">
            ...
            <div style="font-family:'Brush Script MT','Segoe Script',cursive;font-size:26px;color:#1a1a1a;margin:10px 0 6px;">${waiver?.full_name || firstName}</div>
        ...
        <div style="font-family:Arial,Helvetica,sans-serif;font-size:8px;letter-spacing:2px;text-transform:uppercase;color:#999;margin-bottom:8px;">Full Waiver Text — For Your Records</div>
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#fafaf9;border:1px solid rgba(0,0,0,0.08);margin-bottom:24px;">
          <tr><td style="padding:16px 18px;">
            <div style="font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.7;color:#777;white-space:pre-wrap;">${waiver.waiver_text_snapshot.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;')}</div>
          </td></tr>
        </table>` : ''}
