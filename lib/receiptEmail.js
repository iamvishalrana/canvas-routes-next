...
const COPY = {
  fr: {
    ...
    body: itemLabel => `Veuillez trouver ci-joint votre re&ccedil;u pour ${itemLabel}. Vous y trouverez la version fran&ccedil;aise (page&nbsp;1) et la version anglaise (page&nbsp;2).`,
  ...
  en: {
    ...
    body: itemLabel => `Please find your receipt attached for ${itemLabel}. It includes the French version (page 1) and the English version (page 2).`,
