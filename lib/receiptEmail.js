  ...
  <tr><td align="center" style="padding:32px 16px 48px;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:580px;">
      ...
      <tr><td style="background:#ffffff;padding:36px 40px 32px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid rgba(0,0,0,0.1);border-radius:6px;margin-bottom:28px;">
          ...
          <tr><td style="padding:20px 24px 4px;">
            ...
            ${billedToName ? `<div style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#999;margin-top:4px;">Billed to ${billedToName}${billedToEmail ? ` &middot; ${billedToEmail}` : ''}</div>` : ''}
          </td></tr>
      ...
      <tr><td style="background:#0F1E14;padding:16px 40px;">
        <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:11px;color:rgba(245,241,236,0.3);">&copy; 2026 &Eacute;v&eacute;nements Canvas Routes Inc. &mdash; Montreal, QC. &nbsp;&middot;&nbsp; <a href="https://canvasroutes.com" style="color:rgba(197,168,130,0.4);text-decoration:none;">canvasroutes.com</a></p>
      </td></tr>
    </table>
  </td></tr>
</table>
