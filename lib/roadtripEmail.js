...
export function buildRouteLaunchHtml({ firstName, routeName, monthLabel, destination, message }) {
  ...
  return shell({
    ...
    bodyHtml: `
        ...
        ${note ? `<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#F5F1EC;border-left:3px solid #c5a882;margin-bottom:28px;"><tr><td style="padding:18px 20px;"><p style="margin:0;font-family:Georgia,'Times New Roman',serif;font-size:14px;line-height:1.75;color:#444;white-space:pre-wrap;">${note.replace(/</g, '&lt;')}</p></td></tr></table>` : ''}
        <p style="margin:0 0 1em;font-family:Georgia,'Times New Roman',serif;font-size:15px;line-height:1.8;color:#555;">We&rsquo;ll follow up with the meeting point, the full route, and convoy rules. Questions? Just reply to this email.</p>`,
  })
}
