  ...
  return (
    <div className="gpg-authed">
      ...
      {totalPhotos === 0 ? (
        ...
        <>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.4rem', fontSize: '11px', color: '#8A6535', background: 'rgba(197,168,130,0.08)', border: '0.5px solid rgba(197,168,130,0.25)', borderRadius: '8px', padding: '0.6rem 0.8rem', marginBottom: '1.25rem', fontFamily: 'var(--font-inter), sans-serif', lineHeight: 1.55 }}>
            ...
            <span>Previews are compressed so they load quickly — every download is the full-resolution original.</span>
          </div>
