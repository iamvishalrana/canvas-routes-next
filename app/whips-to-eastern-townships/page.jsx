...
const STOPS = [
  ...
  { label: 'Vignoble Domaine du Brésée', note: 'Dunham · Vineyard stop', href: 'https://maps.app.goo.gl/NxphbdWfFfJpFfYr7', lat: 45.1255, lng: -72.8678 },
  ...
  { label: 'Auberge Est — McGowan Restaurant', note: 'Georgeville · Lunch — Final destination', end: true, href: 'https://www.google.com/maps?q=45.1569,-72.0797', lat: 45.1569, lng: -72.0797 },
]
      ...
      <div style={{ maxWidth: '740px', margin: '0 auto', padding: '0 1.25rem 4rem' }}>
        ...
        <div style={{ padding: '2rem 0', borderBottom: '0.5px solid rgba(0,0,0,0.1)' }}>
          ...
          <p style={{ fontSize: '14px', color: '#444', lineHeight: '1.8', margin: '0 0 0.75rem' }}>
            We leave Brossard, cross the bridge, and head east toward Bromont. After fuelling up at the Shell station by the outlets, we head south through Dunham wine country for a stop at Vignoble Domaine du Brésée.
          </p>
          <p style={{ fontSize: '14px', color: '#444', lineHeight: '1.8', margin: '0 0 0.75rem' }}>
            From there we pick up Chemin des Cantons — one of Quebec's best driving roads — through Sutton, Glen Sutton, and Highwater before the road opens back up through Austin and Magog along Lake Memphrémagog.
          </p>
          <p style={{ fontSize: '14px', color: '#444', lineHeight: '1.8', margin: 0 }}>
            We end at Auberge Est Restaurant McGowan in Georgeville for lunch on the lake. Then the drive home.
          </p>
        </div>
