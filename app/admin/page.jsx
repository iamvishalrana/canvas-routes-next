  ...
  const sidebarContent = (
    <>
      <div style={{ padding: '1.75rem 1.5rem 1.5rem', borderBottom: '0.5px solid rgba(255,255,255,0.08)' }}>
        <Link href="/">
          <Image src="/canvas_routes_refined.png" alt="Canvas Routes" width={1500} height={999} style={{ height: '52px', width: 'auto', filter: 'brightness(0) invert(1)', opacity: 0.9, display: 'block' }} />
        </Link>
    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', fontFamily: 'var(--font-inter),sans-serif' }}>
      ...
      {isMobile && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, height: '56px', background: '#0F1E14', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 1.25rem', zIndex: 300, borderBottom: '0.5px solid rgba(255,255,255,0.08)' }}>
          <Link href="/">
            <Image src="/canvas_routes_refined.png" alt="Canvas Routes" width={1500} height={999} style={{ height: '34px', width: 'auto', filter: 'brightness(0) invert(1)', opacity: 0.9, display: 'block' }} />
          </Link>
