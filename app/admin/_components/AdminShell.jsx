...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { href: '/admin/events',          label: 'Meets & Events'  },
      { href: '/admin/upcoming-routes', label: 'Routes' },
    ],
  },
  {
...
function BirthdaysWidget() {
  ...
  return (
    <div style={{ borderTop: '0.5px solid rgba(197,168,130,0.1)', flexShrink: 0, padding: '0.85rem 1.1rem 1rem' }}>
      {/* Header — the icon+label open the full Calendar page (events,
          birthdays, and day notes you can write/edit/delete); the arrows
          alongside just page this mini preview's month, same as before. */}
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.6rem' }}>
        <Link href="/admin/calendar" title="Open full calendar" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
      ...
      <aside style={{
        ...
        <div className="admin-sidebar-safe-top" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem 1.25rem', borderBottom: '0.5px solid rgba(197,168,130,0.1)', flexShrink: 0 }}>
          <Link href="/" onClick={() => setIsOpen(false)} style={{ display: 'flex' }}>
            ...
            <img src="/white-outline.png" alt="Canvas Routes" width={1024} height={1536} style={{ width: '80px', height: 'auto', opacity: 0.9 }} />
          </Link>
