...
export async function POST(request, { params }) {
  ...
  // Sending can mean up to MAX_RECIPIENTS/RESEND_BATCH_SIZE (20) sequential
  // Resend calls — awaiting that before responding risks a client timeout
  // (CLAUDE.md rule 8). after() lets the route respond immediately once the
  // route itself is launched; the admin UI shows a recipient count, not a
  // live sent/failed tally.
