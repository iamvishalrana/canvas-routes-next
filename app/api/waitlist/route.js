...
function customerHtml(firstName) {
  return emailShell({
    ...
    preheader: `We've got your application, ${firstName} — we review every one personally and will be in touch.`,
    eyebrow: 'Canvas Routes &middot; Application',
    heading: `We&rsquo;ve got your application, ${h(firstName)}.`,
    body: `
      ${p(`Thank you for applying to Canvas Routes. We review every application personally and will be in touch directly.`)}
      ${accentCard(`
        ${eyebrow(`What&rsquo;s next`, { mb: '8px' })}
        ${p(`Expect a personal email from our team. To make sure it reaches you, add <a href="mailto:info@canvasroutes.com" style="color:#3B6B2F;text-decoration:none;">info@canvasroutes.com</a> to your contacts now.`, { tone: 'muted', mb: '0' })}`)}
      ${instagram()}
    `,
  })
}
