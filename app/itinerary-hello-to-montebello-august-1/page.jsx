...
const DRIVE_BULLETS = [
  ...
  { emoji: '🔁', text: "It's a loop, not an out-and-back — about 300km total, split across two completely different routes. Every kilometre of pavement is new, there and back." },
]
