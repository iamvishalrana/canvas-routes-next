...
const DRIVE_BULLETS = [
  ...
  { emoji: '🏰', text: "Lunch at Aux Chantignoles, inside Fairmont Le Château Montebello — the largest log château in the world, right on the Ottawa River. Cars parked out front for the afternoon. Lunch is a three-course Wednesday Table d'Hôte: rotini salad with pesto, green olives, balsamic and grilled chicken, or squash ravioli in a cheese and sage sauce (vegetarian option). Tax, gratuity, and parking are all covered by Canvas Routes — drinks are not included." },
