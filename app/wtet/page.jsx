      ...
      <section className="wtet-itinerary" style={{position:'relative',padding:'6rem 2rem 7rem',overflow:'hidden'}}>
        ...
        <div style={{maxWidth:'560px',margin:'0 auto',position:'relative',zIndex:2}}>
          ...
          {[
            ...
            { label:'Winery Experience', venue:'Vignoble Domaine du Brésée', venueHref:'https://maps.app.goo.gl/NxphbdWfFfJpFfYr7', address:'Dunham, QC', desc:'A private winery experience at one of the Eastern Townships\' most celebrated vineyards. Cars on the grounds, a chance to take in the property and pick up a bottle. Canvas Routes guests receive a special discount on wine purchases.', pays:true },
