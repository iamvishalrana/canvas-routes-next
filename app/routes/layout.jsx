export const metadata = {
  title: { absolute: 'Upcoming Routes | Canvas Routes' },
  ...
  openGraph: {
    ...
    images: [{ url: 'https://canvasroutes.com/api/og?type=event&title=Upcoming+Routes&date=2026+Season', width: 1200, height: 630, alt: 'Upcoming Routes — Canvas Routes 2026 Season' }],
  },
  twitter: {
    ...
    images: ['https://canvasroutes.com/api/og?type=event&title=Upcoming+Routes&date=2026+Season'],
  },
}
