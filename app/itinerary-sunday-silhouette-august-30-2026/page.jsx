...
const CAR_FACTS = {
  ...
  'Anass Ghandour': "The only M3 BMW ever built with a V8 — a screaming naturally aspirated 4.0-litre that revs all the way to 8,300 RPM, a number no M3 since has come close to. This one's the convertible too, with a retractable hardtop roof, and 2013 was the final year before M3 went turbocharged for good.",
}

const DRIVE_BULLETS = [
  { emoji: '⏰', text: { en: "Arrive on time. We'll use the half hour between meetup and departure for a quick pre-trip briefing and a look around everyone's cars — then we roll out together at 8:00 AM sharp.", fr: "Arrivez à l'heure. Nous profiterons de la demi-heure entre le rassemblement et le départ pour un court briefing et un tour des voitures — puis nous partons ensemble à 8 h précises." } },
  ...
  { emoji: '📸', text: { en: "We'll roll into Petinos around noon — time for a group photo and to swap stories about the fun, curvy drive we just had.", fr: "On arrive chez Petinos vers midi — le temps d'une photo de groupe et de reparler de la route sinueuse et amusante qu'on vient de faire." } },
]
